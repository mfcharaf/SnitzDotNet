...
/* TODO:
    ...
    public class SnitzProfileProvider : ProfileProvider
    {
        ...
        private string _sqlConnectionString = ConfigurationManager.ConnectionStrings["ForumConnectionString"].ConnectionString;
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            _sqlConnectionString = ConfigurationManager.ConnectionStrings["ForumConnectionString"].ConnectionString;
