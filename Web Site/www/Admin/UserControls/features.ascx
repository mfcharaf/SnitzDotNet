<%@ Control Language="C#" AutoEventWireup="true" Inherits="Admin_features" Codebehind="features.ascx.cs" %>
    ...
    <h2 class="category">Feature Configuration</h2>
        ...
        <asp:Panel ID="Panel4" runat="server" GroupingText="Forum Features" 
            ...
            <br />
            <asp:Label ID="lblSearchForums" runat="server" Text="Allow search in all forums" 
                AssociatedControlID="rblSearchAllForums" meta:resourcekey="lblStatisticsResource1"></asp:Label>
            <uc1:AdminRadioButton ID="rblSearchAllForums" runat="server" /> 
        </asp:Panel>
