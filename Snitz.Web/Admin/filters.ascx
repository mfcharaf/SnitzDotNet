...
<asp:Panel ID="Panel4" runat="server" CssClass="ConfigForm clearfix" Visible="True">
        ...
        <asp:LinkButton ID="btnNewWordFilter" runat="server" OnClick="btnNewWordFilter_Click" Text="Add" />
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                        ...
                        <Columns>
                            ...
                            <asp:CommandField ItemStyle-Width="40px" ButtonType="Image" ShowEditButton="True" EditImageUrl="../App_Themes/BlueGray/images/admin/write.png" InsertVisible="False" CancelImageUrl="../App_Themes/BlueGray/images/admin/cancel.png" UpdateImageUrl="../App_Themes/BlueGray/images/admin/ok.png" DeleteImageUrl="../App_Themes/BlueGray/images/admin/trash.png" ShowDeleteButton="True" />
                        </Columns>
    ...
    <asp:Panel ID="Panel2" runat="server" Visible="False" >
        ...
        <asp:GridView ID="GridView2" CellPadding="2" runat="server" AutoGenerateColumns="False" DataSourceID="dsNameFilter" Width="80%" style="margin:auto;"  CssClass="ForumList" DataKeyNames="Id">
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Username to Filter" >
                    <ItemStyle Wrap="False" HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:CommandField ItemStyle-Width="40px" ButtonType="Image" CancelImageUrl="../App_Themes/BlueGray/images/admin/cancel.png" DeleteImageUrl="../App_Themes/BlueGray/images/admin/trash.png"
                    EditImageUrl="../App_Themes/BlueGray/images/admin/write.png" UpdateImageUrl="../App_Themes/BlueGray/images/admin/ok.png" ShowEditButton="True" ShowDeleteButton="True" />
            </Columns>
            <HeaderStyle CssClass="category" />
        </asp:GridView>
