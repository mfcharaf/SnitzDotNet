    ...
    $.fn.extend({
        jsShare: function(options) {
            var settings = $.extend({
                ...
                linkedin: true,
                googlebuzz: false,
                yoursitetitle: forumTitle,
                yoursiteurl: forumUrl,
                yoursitename: forumName,
                desc: forumDesc
            }, options);
            return this.each(function () {
                ...
                function getButton(index, button, title) {
                    ...
                    return $('<li/>').append($('<a/>')
                                                    ...
                                                    .attr('alt', '').css({ width: 16, height: 16, marginTop: 1 })).hover(function () {
                                                        ...
                                                        var b = $(this);
                                                        if (settings.animate)
                                                            b.find('img').stop(false, true).animate({ height: 20, width: 20, marginTop: 0 }, 300);
                                                        //tooltip.html(b.attr('alt'));
                                                        ...
                                                        if (settings.animate)
                                                            $(this).find('img').stop(false, true).animate({ width: 16, height: 16, marginTop: 3 }, 300);
                ...
                $.each(mediaSource, function(index, media) {
                    switch (index) {
                        ...
                        case 6:
                            if (settings.googlebuzz) buttons.append(getButton(index, 'buzz', 'Share with Google Buzz')); break;
                        case 7:
