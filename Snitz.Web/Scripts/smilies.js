...
function fillEmoticons() {
    ...
    emoticons.push(new emoticon("", "[/noparse]", ""));
    emoticons.push(new emoticon("delete", "delete", "delete.gif"));
    emoticons.push(new emoticon("edit", "edit", "edit.gif"));
    emoticons.push(new emoticon("pencil", "pencil", "pencil.gif"));
