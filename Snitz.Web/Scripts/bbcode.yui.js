...
var tagname_re = /^\/?(?:b|i|u|samp|code(?:=[a-z]{1,9})?|colou?r|gold|orange|pink|grey|black|silver|gray|white|maroon|red|purple|fuchsia|green|lime|olive|yellow|navy|blue|teal|aqua|size(?:=[0-9]{1,3})?|noparse|url|img(?:=[a-z]{4,})?|video|s|q|quote|ltr|rtl|br|hr|left|right|center|file|list(?:=[a-z0-9]{1,3})?|[\*]|table|tr|td|th)$/;
    ...
    if (isValidTag(m2)) {
        ...
        switch (m2) {
            ...
            case "img":
                ...
                var img_starttag = "<img style=\"width:99% !important;max-width:200;\" src=\"";
                if (m3)
                    img_starttag = "<img style=\"width:99% !important;max-width:200;float:" + m3 + "\" src=\"";
                return img_starttag;
            case "url":
