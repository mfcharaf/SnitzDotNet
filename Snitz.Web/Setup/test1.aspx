<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test1.aspx.cs" Inherits="SnitzUI.Setup.test1" %>
...
<ajaxToolkit:ToolkitScriptManager runat="Server" EnablePartialRendering="true" ID="ScriptManager1" />       
    <div id="topsection">
        ...
        <div class="innertube clearfix">
            <div id="LogoDIV">
                <asp:HyperLink ID="homeLink"  runat="server" EnableViewState="False"></asp:HyperLink>
            </div>
            <div id="TitleDIV">
            </div>
        </div>
