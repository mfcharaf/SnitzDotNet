            ...
            <ContentTemplate>
                        ...
                        <ContentTemplate>
                            <div id="pMain">
                                <asp:Panel runat="server" ID="pnlAvatar" GroupingText="<%$ Resources:webResources, lblAvatar %>">
                                    ...
                                    <asp:CheckBox ID="cbxGravatar" runat="server" Text="Use Gravatar image" /></asp:Panel>
                                <asp:Panel ID="account" runat="server" GroupingText="<%$ Resources:webResources, lblProfile %>">
                                    <asp:Label ID="lblName" runat="server" Text="<%$ Resources:webResources, lblUserName %>"
                                        AssociatedControlID="tbxName" EnableViewState="False"></asp:Label><asp:TextBox ID="tbxName"
                                            runat="server" EnableViewState="False"></asp:TextBox><br />
                                    <asp:Label ID="lblRealName" runat="server" AssociatedControlID="tbxRealName" Text="<%$ Resources:webResources, lblName %>"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxRealName" runat="server"></asp:TextBox><br />
                                    <asp:Label ID="lblAge" runat="server" AssociatedControlID="tbxAge" Text="<%$ Resources:webResources, lblAge %>"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxAge" runat="server"></asp:TextBox><br />
                                    <asp:Label ID="lblMarStatus" AssociatedControlID="ddlMarStatus" runat="server" Text="<%$ Resources:webResources, lblMarStatus %>"
                                    ...
                                    <asp:Label ID="lblGender" AssociatedControlID="ddlGender" runat="server" Text="<%$ Resources:webResources, lblGender %>"
                                    ...
                                    <br />
                                    <asp:Label ID="lblState" AssociatedControlID="tbxState" runat="server" Text="<%$ Resources:webResources, lblState %>"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxState" runat="server" EnableViewState="False"></asp:TextBox><br />
                                    <asp:Label ID="lblCity" AssociatedControlID="tbxCity" runat="server" Text="<%$ Resources:webResources, lblCity %>"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxCity" runat="server" EnableViewState="False"></asp:TextBox><br />
                                    <asp:Label ID="lblCountry" AssociatedControlID="tbxCountry" runat="server" Text="<%$ Resources:webResources, lblCountry %>"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxCountry" runat="server" EnableViewState="False"></asp:TextBox><br />
                                    <asp:Label ID="lblOccupation" AssociatedControlID="tbxOccupation" runat="server"
                                        Text="<%$ Resources:webResources, lblOccupation %>" EnableViewState="False"></asp:Label><asp:TextBox
                                            ID="tbxOccupation" runat="server" EnableViewState="False"></asp:TextBox><br />
                                    <asp:Label ID="lblTitle" AssociatedControlID="tbxForumTitle" runat="server" Text="Forum Title"
                                        EnableViewState="False"></asp:Label><asp:TextBox ID="tbxForumTitle" runat="server"
                                            EnableViewState="False"></asp:TextBox><br />
                                    <span>
                                        <asp:CheckBox ID="cbxReceiveEmail" CssClass="email" runat="server" Text="<%$ Resources:webResources, lblReceiveEmail %>" /><br />
                                        <asp:CheckBox ID="cbxHideEmail" CssClass="email" runat="server" Text="<%$ Resources:webResources, lblHideEmail %>" /><br />
                                        <br />
                                        <asp:TextBox ID="newemail" runat="server">Enter a new Email ..</asp:TextBox>&#160;<asp:LinkButton
                                            ID="btnChangeEmail" runat="server" Text="<%$ Resources:webResources, lblChangeEmail %>"
                                            OnClick="ChangeEmailClick" /><br />
                                        <asp:Label runat="server" ID="Lemail" Text="Your new email will become current when you have finished the email validation process"
                                            Visible="False" EnableViewState="False"></asp:Label></span></asp:Panel>
                            </div>
                            <asp:Panel runat="server" ID="pnlPassword" GroupingText="Password" Style="float: right;
                                width: 49%; height: auto; min-height: 100px;">
                            ...
                            <asp:Panel runat="server" ID="pnlDOB" GroupingText="Date of Birth" Style="float: right;
                                width: 49%; height: auto; min-height: 130px;">
                ...
                &lt;br /&gt;Only the administrator will have access to your Date of Birth, normal users will only see your age unless the hide age option is selected.&lt;br /&gt; 
                        " EnableViewState="False"></asp:Literal></p>
                                <asp:CheckBox ID="cbxHideAge" runat="server" Text="<%$ Resources:webResources, lblHideAge %>" /></asp:Panel>
...
<br />
                                    ...
                                    <ItemTemplate>
                                        <asp:Panel ID="EditLinks" runat="server">
                                            <asp:TextBox ID="tbxName" runat="server" Text='<%# Eval("Name") %>'></asp:TextBox><asp:TextBox
                                                ID="tbxUrl" runat="server" Text='<%# Eval("Url") %>' Width="50%" /></asp:Panel>
                                        <asp:Panel ID="ViewLinks" runat="server">
                                            <asp:HyperLink ID="hypLink" runat="server" Text='<%# Eval("Name") %>' NavigateUrl='<%# Eval("Url") %>'></asp:HyperLink></asp:Panel>
                                    </ItemTemplate>
                                </asp:Repeater>
                                <asp:LinkButton ID="btnAddLink" runat="server" OnClick="AddLinkClick" Text="<%$ Resources:webResources, btnAddLink %>" />
                                <asp:LinkButton ID="btnSaveLinks" runat="server" OnClick="SaveLinkClick" Text="<%$ Resources:webResources, btnSaveLink %>" /></asp:Panel>
                    ...
                    <asp:TabPanel ID="TabOther" runat="server" HeaderText="Other ..">
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="pnlRoles" GroupingText="<%$ Resources:webResources, lblRoleTitle %>"
                                ...
                                <asp:Literal ID="LitRoles" runat="server" EnableViewState="False"></asp:Literal></asp:Panel>
                            ...
                            <asp:Panel ID="pnlTopics" runat="server" GroupingText="<%$ Resources:webResources, lblRecentTopics %>"
                                ...
                                <asp:GridView ID="rptRecentTopics" runat="server" OnRowDataBound="RecentTopicsDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Content/Forums/topic.aspx?TOPIC=" + Eval("Id")%>'><%# Eval("Subject") %></asp:HyperLink></ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <EmptyDataTemplate>
                                        No recent Topics</EmptyDataTemplate>
                                </asp:GridView>
                            </asp:Panel>
                            ...
                            <asp:Repeater ID="dlImages" runat="server">
                                <ItemTemplate>
                                    <asp:HyperLink NavigateUrl='<%# Eval("ImagePath") %>' ToolTip='<%# Eval("Name") %>'
                                        ...
                                        <asp:Image ImageUrl='<%# Eval("ThumbPath") %>' ID="imgThumb" runat="server" CssClass="thumb" /></asp:HyperLink></ItemTemplate>
    ...
    <asp:Panel ID="pnlButton" runat="server" CssClass="profileform" DefaultButton="btnUpdate">
        <fieldset style="padding-right: 6px; padding-left: 6px; padding-bottom: 6px; padding-top: 6px;
            border: 0px;">
                ...
                <div class="mainModalContent">
                    <div id="mainModalContents">
                        <div class="demoarea">
                            ...
                            <div>
                                <strong>Result from Server:</strong></div>
