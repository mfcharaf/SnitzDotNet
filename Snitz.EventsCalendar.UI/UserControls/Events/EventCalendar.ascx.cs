...
namespace EventsCalendar.UserControls
{
    ...
    public partial class EventCalendar : UserControl
    {
        ...
        protected void Calendar1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            IEnumerable<CalEvent> TodaysEvents = GetEventsForToday(_tempDate);
            if (TodaysEvents.Count() > 0)
                temp = "";
            foreach (CalEvent Item in TodaysEvents)
            {
                switch (Item.Type)
                {
			        case 1 :
                ...
                temp += "Title : <a href=\"edit.aspx?ID=" + Item.Id + "\">" + Item.Title + "</a>" + 
                    ...
                    "<br/>Added by : " + Item.Members.Username + "<br/><br/>";
        ...
        private static IEnumerable<CalEvent> GetEventsForToday(DateTime date)
        {

            return Util.GetEventsForToday(date.ToForumDateStr());
        }
